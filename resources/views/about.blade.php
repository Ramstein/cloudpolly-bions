        ...
        <div class="container pt-9">         
            ...
            <div class="row d-flex" id="about-us">
                ...
                <div class="col-md-6" id="about-info">
                    ...
                    <p>CloudPolly is a service that turns text into lifelike speech, allowing you to create applications that talk, and build entirely new categories of speech-enabled products. Polly's Text-to-Speech (TTS) service uses advanced deep learning technologies to synthesize natural sounding human speech. With dozens of lifelike voices across a broad set of languages, you can build speech-enabled applications that work in many different countries.</p>
                    
                    <p>In addition to Standard TTS voices, CloudPolly offers Neural Text-to-Speech (NTTS) voices that deliver advanced improvements in speech quality through a new machine learning approach. Polly’s Neural TTS technology also supports a Newscaster speaking style that is tailored to news narration use cases.</p>

                    <p>Finally, CloudPolly Brand Voice can create a custom voice for your organization. This is a custom engagement where you will work with the CloudPolly team to build an NTTS voice for the exclusive use of your organization.</p>
            ...
            <div class="row d-flex text-center">
                ...
                <div class="col-md-12 mb-4">
                    <h6>{{ __('Text to Speech production is easier and faster with us') }}</h6>
