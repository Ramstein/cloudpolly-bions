        ...
        <div class="col-md-5 col-sm-12 h-100" id="login-responsive">                
            <div class="card-body pr-10 pl-10 pt-10">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <p class="fs-10 text-muted pt-3">{{ __('By continuing, you agree to our') }} <a href="https://castme.life/terms-and-conditions/" target="_blank" class="text-info">{{ __('Terms and Conditions') }}</a> {{ __('and') }} <a href="https://bions.us/privacy-policy/" target="_blank" class="text-info">{{ __('Privacy Policy') }}</a></p>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-12 col-sm-12 fs-10 text-muted text-center">
                            Copyright © {{ date("Y") }} <a href="https://cloudpolly.bions.us/" target="_blank">{{ config('app.name') }}</a>. {{ __('All rights reserved') }}
                        </div>
                    </div>
                </div>
            </footer>       
