                        ...
                        <div class="form-group">  
                            <div class="d-flex">                        
                                <label class="custom-switch">
                                    ...
                                    <span class="custom-switch-description fs-10 text-muted">By continuing, I agree with your <a href="https://castme.life/terms-and-conditions/" class="text-info" target="_blank">Terms and Conditions</a> and <a href="https://bions.us/privacy-policy/" target="_blank" class="text-info">Privacy Policies</a></span>
                                </label>   
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-12 col-sm-12 fs-10 text-muted text-center">
                                Copyright © {{ date("Y") }} <a href="https://cloudpolly.bions.us/" target="_blank">{{ config('app.name') }}</a>. All rights reserved
                            </div>
                        </div>
                    </div>
                </footer>       
